...
export default function ChatList() {
  ...
  return (
    <div className='hidden h-full flex-col xl:flex xl:w-1/4'> 
      ...
      <h3 className='text-lg font-medium text-black dark:text-white 2xl:text-xl'>Active Conversations </h3>
      <span className='rounded-md border-[.5px] border-stroke bg-gray px-2 py-0.5 text-base font-medium text-black dark:bg-boxdark-2 dark:text-white 2xl:ml-4'>8</span>
      </div>

      <div className="flex max-h-full flex-col overflow-auto p-5 ">
        <form className="sticky mb-7">
          <input type="text" placeholder="Search..." className="w-full rounded border-stroke bg-gray-2 py-3 pl-4 pr-10 text-sm outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark-2" />
